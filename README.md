# 地图应用中使用JavaScript框架(AngularJS)
这个Demo是2013Esri中国dev summit中《ArcGIS API For Javascript高级应用开发》的demo之一。该单页面应用主要演示如何在地图应用中使用AngularJS框架来实现MV分离，减少代码量，增强应用逻辑性。

----

## 说明
1. 此Demo所展示行政区划是以货币为准，不带有任何政治色彩
2. 此Demo中的汇率来源于[openexchangerates](http://openexchangerates.or)
...
* [微博@ArcGIS技术服务](http://weibo.com/esritech) 
